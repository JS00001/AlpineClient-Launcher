...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((windowName, options) => {
  ...
  const ensureVisibleOnSomeDisplay = windowState => {
    ...
    return resetToDefaults(); // Removed below, and added above to always spawn in center - Maxi
    // if (!visible) {
  ...
  const browserOptions = _objectSpread(_objectSpread(_objectSpread({}, options), state), {}, {
    width: defaultSize.width || 1200,
    height: defaultSize.height || 800,
...
(async () => {
  ...
  electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.on('minimize-window', () => {
    mainWindow.minimize();
  });
  electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.on('close-window', () => {
    mainWindow.close();
  });
